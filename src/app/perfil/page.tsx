      ...
      <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in duration-500">
        <header>
          ...
          <p className="text-[var(--text-muted)]">
            Gerencie suas informações pessoais e preferências de conta no PubHub.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <section className="bg-red-500/5 border border-red-500/20 rounded-xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-lg font-semibold text-white mb-1">Zona de Perigo</h3>
              <p className="text-sm text-[var(--text-muted)]">
                Ao sair da conta, você precisará se autenticar novamente para acessar o dashboard.
              </p>
            </div>
            <LogoutButton
              className="px-8 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all font-semibold shadow-lg shadow-red-600/20 active:scale-95 whitespace-nowrap"
            >
              Sair da Conta
            </LogoutButton>
          </section>
